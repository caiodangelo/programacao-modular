...
*       4.00   cev   15/09/2009 Extensão para múltiplas árvores n-árias
...
*  ****/
   ...
   ARV_tpCondRet ARV_InserirFilho( tpArvore * pArvore, char ValorParm )
   {
      ...
      /* Criar nó  */
         ...
         pArvore->pNoCorr = pNo ;
         return ARV_CondRetOK ;
   } /* Fim função: ARV Adicionar filho */
...
*  ****/
   ...
   } /* Fim função: ARV Ir para nó filho */
...
*  ****/
   ...
   } /* Fim função: ARV Ir para nó irmão */
